...
<Metrics>
  ...
  <Metric value="69%" label="share of night-time activity among those users. For everyone else it was 17%" />
</Metrics>
...
Korea has had no daylight saving since 1988. KST boundaries can therefore be derived exactly with UTC+9 arithmetic, with no timezone database and no library. **A constant that does not depend on configuration beats correctness that does.**
</Callout>
