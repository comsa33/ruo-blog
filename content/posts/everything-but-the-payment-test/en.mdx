...
When the first fix is logically right and the symptom doesn't move, suspect a second cause before abandoning the hypothesis.
...
The loss itself is small. Eleven app payments in August, 69,300 KRW, became zero in September. The problem isn't the amount. It is that one revenue path was 100% dead and for ten days no instrument mentioned it.
