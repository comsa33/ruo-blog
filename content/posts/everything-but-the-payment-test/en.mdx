...
<Structure
  ...
  nodes={[
    { id: 'js', label: 'WebView JS', sub: 'store.initialize()', col: 0, row: 0, note: 'Where the web code starts a purchase. Nothing was ever wrong this far along.' },
    { id: 'bridge', label: 'ExposedJsApi', sub: 'JS→native', col: 1, row: 0, note: 'The bridge that carries a JS call into native. R8 deleted it whole. Restored on the second attempt.' },
    { id: 'manager', label: 'PluginManager', sub: 'Cordova', col: 2, row: 0, note: 'Takes a service name and finds the class. What it looks the name up in is not itself — it is config.xml.' },
    { id: 'plugin', label: 'PurchasePlugin', sub: 'cc.fovea', col: 3, row: 0, note: 'Sitting in the APK the whole time. Nobody was calling its name.' },
    { id: 'config', label: 'config.xml', sub: 'res/xml', col: 2, row: 1, accent: true, note: 'The plugin registry. The resource shrinker judged it unused and deleted it. This one file is why Class not found happened.' },
    { id: 'billing', label: 'BillingClient', sub: 'Play Billing', col: 3, row: 1, note: 'The layer that actually talks to Google Play. Logcat was silent because nothing ever reached here.' },
  ]}
  edges={[
    { from: 'js', to: 'bridge' },
