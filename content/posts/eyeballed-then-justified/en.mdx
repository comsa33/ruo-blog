...
And the second smallest value is 1.22 (Budapest). Nothing sits between 0.94 and 1.22, so there was no decision to make about whether the threshold belongs at 1.0 or 1.1. Move the line in the figure above and only Brussels changes sides. I didn't choose the number. There wasn'thing to choose.
