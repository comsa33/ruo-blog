...
The $100 line is poorly justified. It is a number picked as a tolerable ceiling on loss, not one derived from any analysis. I can't explain it beyond "about ten times current cost". I wrote elsewhere that thresholds should be measured rather than chosen, and here I chose one.
