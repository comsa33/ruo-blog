...
<Figure
  src="/posts/saju-halmae-making-of-1/sessions.webp"
  alt="Twelve terminal panes, each running one Claude Code session, labelled with roles such as lead, contents creator, marketing advertising, app development, planner, odd jobs, writer, appbuild, designer and QA"
  caption="The sessions on the afternoon of the submission day, one role per pane: lead, content creator, marketing, app development, planner, writer, designer, QA and more"
/>
