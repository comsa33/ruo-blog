...
<Callout label="The nature of this bug">
  **"It works while running" is the worst possible symptom.** The server is always up at the moment
  a developer checks. You deploy, you test, you report success, and that night the pod restarts and
  it breaks. When the moment of verification and the moment of destruction are different, no amount
  of diligence catches it.
</Callout>
